...
const krystalwallet = window.krystalwallet;
...
describe("TrustWeb3Provider constructor tests", () => {
  ...
  test("test Solana setAddress", () => {
    const provider = new krystalwallet.SolanaProvider({
      solana: {
  ...
  test("test setConfig", (done) => {
    const provider = new krystalwallet.Provider({ ethereum: ropsten });
    const web3 = new Web3(provider);
  ...
  test("test eth_chainId", (done) => {
    const provider = new krystalwallet.Provider({ ethereum: bsc });
    const web3 = new Web3(provider);
  ...
  test("test eth_accounts", (done) => {
    const provider = new krystalwallet.Provider({ ethereum: mainnet });
    const web3 = new Web3(provider);
  ...
  test("test eth_sign", (done) => {
    ...
    const signed =
      ...
      krystalwallet.postMessage = (message) => {
